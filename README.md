...
data:
  mapRoles: |
    - groups:
      ...
      - system:nodes
      rolearn: arn:aws:iam::886819535038:role/eks-dev-EksNodeWorkerRole-123456789
      username: system:node:{{EC2PrivateDNSName}}
    - groups:
      - system:masters
      rolearn: arn:aws:iam::886819535038:role/eks-dev-EksRbacAdminRole-123456789
      username: ec2-admin
    - groups:
      - system:masters
      rolearn: arn:aws:iam::886819535038:role/my-role-name
      username: cre-admin
kind: ConfigMap
metadata:
